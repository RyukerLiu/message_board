"""
Django settings for ch08_test project.
...
SECRET_KEY = 'xvm7%h9rf!n$o-d9^kh*^9qbyvcob9es0v+ew-d3sxrxz$lh+f'
...
WSGI_APPLICATION = 'ch08_test.wsgi.application'
